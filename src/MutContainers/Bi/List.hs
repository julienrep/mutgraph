...
class ReplicateM (l :: * -> *) a where replicateM :: (MutMonad s m) => SizeOf l -> m a -> m (Mut2 s l a)
class ReplicateMM (l :: * -> *) a where replicateMM :: (MutMonad s m) => SizeOf l -> m (Mut s a) -> m (Mut2 s l (Mut s a))
instance (forall _a. ReplicateM l _a) => ReplicateMM (l :: * -> *) a where replicateMM = replicateM

class PushFrontM (l :: * -> *) a where pushFrontM :: (MutMonad s m) => Mut2 s l a -> a -> m ()
class PushFrontMM (l :: * -> *) a where pushFrontMM :: (MutMonad s m) => Mut2 s l (Mut s a) -> Mut s a -> m ()
instance (forall _a. PushFrontM l _a) => PushFrontMM (l :: * -> *) a where pushFrontMM = pushFrontM
class PushFrontMC (l :: * -> *) a where pushFrontMC :: (MutMonad s m) => Mut2 s l (Cst s a) -> Cst s a -> m ()
instance (forall _a. PushFrontM l _a) => PushFrontMC (l :: * -> *) a where pushFrontMC = pushFrontM

class PushBackM (l :: * -> *) a where pushBackM :: (MutMonad s m) => Mut2 s l a -> a -> m ()
class PushBackMM (l :: * -> *) a where pushBackMM :: (MutMonad s m) => Mut2 s l (Mut s a) -> Mut s a -> m ()
instance (forall _a. PushBackM l _a) => PushBackMM (l :: * -> *) a where pushBackMM = pushBackM
class PushBackMC (l :: * -> *) a where pushBackMC :: (MutMonad s m) => Mut2 s l (Cst s a) -> Cst s a -> m ()
instance (forall _a. PushBackM l _a) => PushBackMC (l :: * -> *) a where pushBackMC = pushBackM

class PopFrontM (l :: * -> *) a where popFrontM :: (MutMonad s m) => Mut2 s l a -> m a
class PopFrontMM (l :: * -> *) a where popFrontMM :: (MutMonad s m) => Mut2 s l (Mut s a) -> m (Mut s a)
instance (forall _a. PopFrontM l _a) => PopFrontMM (l :: * -> *) a where popFrontMM = popFrontM
class PopFrontMC (l :: * -> *) a where popFrontMC :: (MutMonad s m) => Mut2 s l (Cst s a) -> m (Cst s a)
instance (forall _a. PopFrontM l _a) => PopFrontMC (l :: * -> *) a where popFrontMC = popFrontM

class PopBackM (l :: * -> *) a where popBackM :: (MutMonad s m) => Mut2 s l a -> m a
class PopBackMM (l :: * -> *) a where popBackMM :: (MutMonad s m) => Mut2 s l (Mut s a) -> m (Mut s a)
instance (forall _a. PopBackM l _a) => PopBackMM (l :: * -> *) a where popBackMM = popBackM
class PopBackMC (l :: * -> *) a where popBackMC :: (MutMonad s m) => Mut2 s l (Cst s a) -> m (Cst s a)
